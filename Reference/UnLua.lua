...
function UnLua.Class(SuperClass) end

---Hot reload lua modules
---@param ModuleNames? table Specify a list of module names that need hot reloading. If this parameter is not passed, it will be obtained by default according to the file modification timestamp
function UnLua.HotReload(ModuleNames) end
...
---Get the class of an object (Static version). Example: SomeActor:AddComponentByClass(UStaticMeshComponent.StaticClass(), ...)
---@return UClass
function UObject.StaticClass() end

---Load an object. for example: UObject.Load("/Game/Core/Blueprints/AI/BehaviorTree_Enemy.BehaviorTree_Enemy"). Note: No _C at the end of path.
...
---Get the default object of this object's class. Example: "APlayerController:GetDefaultObject()"
---@return UObject
function UObject:GetDefaultObject() end

---Test whether this object is of the specified class
---@param Class UClass
---@return boolean
...
---Load a class. For example: UClass.Load("/Game/Core/Blueprints/AICharacter.AICharacter_C"). Note: There's _C at the end of path.
...
---@param ChildClass UClass
---@param ParentClass UClass
---@return boolean
function UClass.IsChildOf(ChildClass, ParentClass) end

---Get the default object of UClass. Example: "APlayerController.StaticClass():GetDefaultObject()"
---@return UObject
...
---Single-cast delegate. Holds at most one binding.
---@class Delegate
local Delegate = {}

---Bind a callback to the delegate. Replaces previous binding if any.
---@param Function function @callback
function Delegate:Bind(Function) end

---Unbind the callback from the delegate.
...
---Multicast delegate. Holds zero or more bindings.
---@class MulticastDelegate
local MulticastDelegate = {}

---Add a callback to the delegate. Returns a handle for later removal.
---@param Function function @callback
---@return table @handle with :Remove() method
function MulticastDelegate:Add(Function) end

---Remove a specific callback. The function reference must match the one passed to Add.
---@param Function function @callback (must be the same reference passed to Add)
---@return integer @number of removed bindings
function MulticastDelegate:Remove(Function) end

---Remove all callbacks bound from Lua.
function MulticastDelegate:RemoveAll() end

---Broadcast: invoke all bound callbacks with the given arguments.
---Variable argument list (look for target delegate signature).
function MulticastDelegate:Broadcast(...) end

---Returns true if there is at least one binding (Lua or native).
---@return boolean
