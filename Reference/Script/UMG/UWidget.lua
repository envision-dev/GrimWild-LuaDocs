...
---@param Rule EUINavigationRule @The rule to use when navigation is taking place
---@param WidgetToFocus string @When using the Explicit rule, focus on this widget
...
---@param Direction EUINavigation
---@param InWidget UWidget @Focus on this widget instance
