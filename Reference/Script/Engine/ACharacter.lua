...
---@param bClientSimulation? boolean @[default: false]
...
---@param HalfHeightAdjust number @difference between default collision half-height, and actual crouched capsule half-height.
---@param ScaledHalfHeightAdjust number @difference after component scale is taken in to account.
function ACharacter:K2_OnEndCrouch(HalfHeightAdjust, ScaledHalfHeightAdjust) end

---Called from CharacterMovementComponent to notify the character that the movement mode has changed.
---@param PrevMovementMode integer @Movement mode before the change
---@param NewMovementMode integer @New movement mode
---@param PrevCustomMode integer @Custom mode before the change (applicable if PrevMovementMode is Custom)
---@param NewCustomMode integer @New custom mode (applicable if NewMovementMode is Custom)
...
---@param LaunchVelocity FVector @is the velocity to impart to the Character
---@param bXYOverride boolean @if true replace the XY part of the Character's velocity instead of adding to it.
---@param bZOverride boolean @if true replace the Z component of the Character's velocity instead of adding to it.
...
---@param Hit FHitResult @Result describing the landing that resulted in a valid landing spot.
...
---@param PreviousFloorImpactNormal FVector @Normal of the previous walkable floor.
---@param PreviousFloorContactNormal FVector @Normal of the contact with the previous walkable floor.
---@param PreviousLocation FVector @Previous character location before movement off the ledge.
...
---@param InPlayRate? number @[default: 1.000000]
---@param StartSectionName? string @[default: None]
---@return number
...
---@param AnimMontage? UAnimMontage @[default: None]
