...
---@param Player AController @is the controller for whom we are choosing a playerstart
---@return AActor
...
---@param NewPlayer AController @- Controller for whom this pawn is spawned
---@param SpawnTransform FTransform @- Transform at which to spawn pawn
---@return APawn
...
---@param NewPlayer AController @- Controller for whom this pawn is spawned
---@param StartSpot AActor @- Actor at which to spawn pawn
---@return APawn
