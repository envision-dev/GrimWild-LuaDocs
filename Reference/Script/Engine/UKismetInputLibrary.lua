...
---@param A FInputChord @- The chord to compare against
---@param B FInputChord @- The chord to compare
---@return boolean
...
---@param A FKey @- The key to compare against
---@param B FKey @- The key to compare
---@return boolean
...
---@param Key FKey
---@param bLongDisplayName? boolean @[default: true]
---@return string
