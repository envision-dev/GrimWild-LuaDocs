...
---@param DisplayNits? integer @[default: 1000]
...
---@param bForceReload? boolean @[default: false]
...
---@param WorkScale? integer @[default: 10]
---@param CPUMultiplier? number @[default: 1.000000]
---@param GPUMultiplier? number @[default: 1.000000]
