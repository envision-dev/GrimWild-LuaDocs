...
---@param bReset? boolean @[default: false] - Whether the activation should happen even if ShouldActivate returns false.
...
---@param bNewActive boolean @- The new active state of the component
---@param bReset? boolean @[default: false] - Whether the activation should happen even if ShouldActivate returns false.
function UActorComponent:SetActive(bNewActive, bReset) end

---Sets whether the component should be auto activate or not. Only safe during construction scripts.
---@param bNewAutoActivate boolean @- The new auto activate state of the component
