...
---Add item to array
---@param TargetArray TArray<integer> @The array to add item to
---@param NewItem integer @The item to add to the array
---@return integer
...
---@param TargetArray TArray<integer> @The array to add the source array to
---@param SourceArray TArray<integer> @The array to add to the target array
function UKismetArrayLibrary.Array_Append(TargetArray, SourceArray) end

---Clear an array, removes all content
---@param TargetArray TArray<integer> @The array to clear
function UKismetArrayLibrary.Array_Clear(TargetArray) end

---Returns true if the array contains the given item
---@param TargetArray TArray<integer> @The array to search for the item
...
---@param TargetArray TArray<integer> @The array to get an item from
...
---@param ArrayA TArray<integer> @One of the arrays to compare
---@param ArrayB TArray<integer> @The other array to compare
---@return boolean
function UKismetArrayLibrary.Array_Identical(ArrayA, ArrayB) end

---Insert item at the given index into the array.
---@param TargetArray TArray<integer> @The array to insert into
---@param NewItem integer @The item to insert into the array
...
---@param TargetArray TArray<integer> @The array to check
---@return boolean
...
---@param TargetArray TArray<integer> @Array to use for the IsValidIndex test
...
---@param TargetArray TArray<integer> @The array to perform the operation on
---@return integer
function UKismetArrayLibrary.Array_LastIndex(TargetArray) end

---Get the number of items in an array
---@param TargetArray TArray<integer> @The array to get the length of
---@return integer
function UKismetArrayLibrary.Array_Length(TargetArray) end

---Gets a random item from specified array
---@param TargetArray TArray<integer> @The array
---@return integer OutItem @The random item from this array
---@return integer OutIndex @The index of random item (will be -1 if array is empty)
function UKismetArrayLibrary.Array_Random(TargetArray) end

---Gets a random item from specified array (using random stream)
---@param TargetArray TArray<integer> @The array
---@param RandomStream FRandomStream @[out, modified in place] The random stream
---@return integer OutItem @The random item from this array
---@return integer OutIndex @The index of random item (will be -1 if array is empty)
...
---@param TargetArray TArray<integer> @The array to remove from
...
---@param Item integer @The item to assign to the index of the array
---@param bSizeToFit boolean @If true, the array will expand if Index is greater than the current size of the array
function UKismetArrayLibrary.Array_Set(TargetArray, Index, Item, bSizeToFit) end

---Shuffle (randomize) the elements of an array
---@param TargetArray TArray<integer> @The array to shuffle
...
---@param TargetArray TArray<AActor> @The array to filter from
---@param FilterClass TSubclassOf<AActor> @The Actor sub-class type that acts as the filter, only objects derived from it will be returned.
