...
---@param InSocketName string @Name of the socket or the bone to get the transform
---@return boolean
...
---@param InSocketName string @Name of the socket or the bone to get the transform
---@param TransformSpace? integer @[default: RTS_World]
---@return FTransform
...
---@param AttachType? integer @[default: KeepRelativeOffset]
...
---@param bNewAbsoluteLocation? boolean @[default: false]
---@param bNewAbsoluteRotation? boolean @[default: false]
---@param bNewAbsoluteScale? boolean @[default: false]
...
---@param bPropagateToChildren? boolean @[default: false]
