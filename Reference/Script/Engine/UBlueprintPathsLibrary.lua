...
---@param InPath string
---@param InSandboxName string @The name of the sandbox.
---@return string
...
---@param InPath string
---@param bRemovePath? boolean @[default: true]
---@return string
...
---@param PathA string @First path to check.
---@param PathB string @Second path to check.
---@return boolean
...
---@param NewGameProjectFilePath string @- The project file path to set.
