...
---@field public MyItem integer @If the hit result is from a collision this will have extra info about the item that hit the second item.
...
---@field public HitObjectHandle FActorInstanceHandle @Handle to the object hit by the trace.
