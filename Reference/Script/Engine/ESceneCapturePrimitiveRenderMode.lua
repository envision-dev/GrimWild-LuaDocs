...
---@field public PRM_UseShowOnlyList ESceneCapturePrimitiveRenderMode [2] Render only primitives in the ShowOnlyActors list, or components specified with ShowOnlyComponent().
