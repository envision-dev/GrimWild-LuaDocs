...
---@field public OptionalDependencies TArray<FModReference> @Mods this one interoperates with when they are present. Absence is legal; presence after this mod in the load order is not.
