...
---Note: We bind and unbind directly through FScriptDelegate::BindUFunction and
---FMulticastScriptDelegate::AddUnique/Remove instead of going through FDelegateRegistry, since its
---own handler creation (CreateHandler) is private and would duplicate the bookkeeping we already do here.
