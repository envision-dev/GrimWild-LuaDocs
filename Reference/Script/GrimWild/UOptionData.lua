...
---@return string ValueToSet
function UOptionData:ConfigureValueToSet() end
...
---@param Options TArray<string> @[out, modified in place]
...
function UOptionData:GetDefaultOptionValue() end
...
---@return string OutValue
function UOptionData:GetOptionValue() end
