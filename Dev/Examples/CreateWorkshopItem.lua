...
local ItemPreviewFile = "" -- Absolute path on disk, e.g. "D:/MyWorkshopItem/Preview.png". PNG or JPEG, ideally 512x512 or larger
local ItemContentFolder = "C:/Users/PC/Downloads/TestItemContent" -- Absolute folder path on disk, e.g. "D:/MyWorkshopItem/Content".
...
function This.UpdateWorkshopItemComplete(bSuccess)
    ...
    LogInfo("The script has completed its work")
    This:Unload()
end
